...
const display = document.querySelector("#display");  //O querySelector retorna o primeiro elemento do documento.
...
//O else serve para calcular os valores da soma.

//Slice apagar os caracteres.
